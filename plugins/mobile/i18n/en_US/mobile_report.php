...
(
	...
	'incident_month' => array
	(
		'required'		=> 'The month field is required.',
		'numeric' => 'The month field does not appear to contain a valid month?',
		'between' => 'The month field does not appear to contain a valid month?'
	),
	
	'incident_day' => array
	(
		'required'		=> 'The day field is required.',
		'numeric' => 'The day field does not appear to contain a valid day?',
		'between' => 'The day field does not appear to contain a valid day?'
	),
	
	'incident_year' => array
	(
		'required'		=> 'The year field is required.',
		'numeric' => 'The year field does not appear to contain a valid year?',
		'length' => 'The year field does not appear to contain a valid year?'
	),
